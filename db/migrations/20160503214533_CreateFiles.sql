...
CREATE TABLE files (
  ...
  hash   TEXT,
  type   TEXT,
  created_atted_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
...
-- +goose Down
DROP TRIGGER files_trigger_set_created_at ON files;
DROP TRIGGER files_trigger_set_updated_at ON files;
DROP TABLE files;
